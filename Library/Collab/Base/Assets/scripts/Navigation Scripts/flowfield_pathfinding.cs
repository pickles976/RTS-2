...
public class flowfield_pathfinding : MonoBehaviour
{
    ...
    public bool show_dijkstra_debug = true; //draws the ff and dijkstra grids
    public bool show_ff_debug = false;
...
//======================================================================================================//
    ...
    void getAstarPath(ref Stack<Pair<int,int>> path)
    {
        ...
        //if we create an array with width equal to horizontal displacement x2 + 1, and height equal to 
        //vertical displacement x2 + 1, then we will have an array where our start position is at the center
